...
| ------ | --------- | ---------------------------------------- | -------- | ---------------------------------------- | ------------------- | --------------- |
| 1.0    |  Elicitação de Requisitos    | [Yasmim Rosa](https://github.com/yaskisoba), [Millena Queiroz](https://github.com/MillenaQueiroz) e [Maria Clara](https://github.com/alvezclari) | 21/09/2025 | [nome](https://github.com/Nome) | ---- | xx/xx/xxxx |
