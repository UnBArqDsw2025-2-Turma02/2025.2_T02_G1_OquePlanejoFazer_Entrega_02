...
| Excluir tarefa                                       | Permitir que o usuário clique na tarefa e priorize ela. O sistema deve exibir uma mensagem de confirmação antes de excluir a tarefa permanentemente.|
| Finalizar tarefa                                     |Ao ser finalizada, a tarefa deve ser marcada visualmente como concluída (ex: riscada ou com a cor atenuada).|
...
| :--- | :--- | :--- | :--- | :--- | :--- | :--- |
| 1.0 | Elicitação de Requisitos | [Yasmim Rosa](https://github.com/yaskisoba), [Millena Queiroz](https://github.com/MillenaQueiroz) e [Maria Clara](https://github.com/alvezclari) | 21/09/2025 | Nathan Abreu | Correção dos critérios de aceitação para os requisitos 'Excluir tarefa' e 'Finalizar tarefa', garantindo consistência. | 21/09/2025 |